...
#define CHECK_GE_F(a, b, ...) CHECK_OP_F(a, b, >=, ##__VA_ARGS__)
	...
	#define DCHECK_F(test, ...) (void)0;
	#define DCHECK_NOTNULL_F(x, ...) (void)0;
	#define DCHECK_EQ_F(a, b, ...) (void)0;
	#define DCHECK_NE_F(a, b, ...) (void)0;
	#define DCHECK_LT_F(a, b, ...) (void)0;
	#define DCHECK_LE_F(a, b, ...) (void)0;
	#define DCHECK_GT_F(a, b, ...) (void)0;
	#define DCHECK_GE_F(a, b, ...) (void)0;
#endif // NDEBUG
